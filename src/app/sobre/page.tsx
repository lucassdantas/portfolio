...
export default function About () {
  return (
    <Section limiterClassname='relative flex flex-col justify-between h-full' className='h-full text-base_1-a0'>
      <div className='h-1/2 '>
        <Title tag='h2'>Lucas Dantas</Title>
        <Title tag='h1' isBigText={true} className='font-extrabold'>Desenvolvedor Web</Title>
