...
export const CardImages = ({ project, handleImageClick, setIsLightboxOpen }: CardImagesProps) => {
  return (
    <div className="flex w-full justify-between gap-4">
      <div className={`${project.galleryImages.length>0 && 'lg:w-[300px]'} w-full`}>
        <Image
          ...
          className={`cursor-pointer ${project.galleryImages.length>0 && 'lg:w-[300px]'} w-full h-full lg:h-[200px] object-cover`}
        />
      </div>
